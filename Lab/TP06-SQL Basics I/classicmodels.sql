...
-- Dumping data for table classicmodels.customers: ~127 rows (approximately)
...
-- Dumping data for table classicmodels.orderdetails: ~2,704 rows (approximately)
...
-- Dumping data for table classicmodels.orders: ~233 rows (approximately)
...
-- Dumping data for table classicmodels.products: ~142 rows (approximately)
